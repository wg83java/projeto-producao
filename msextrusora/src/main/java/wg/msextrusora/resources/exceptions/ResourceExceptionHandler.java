package wg.msextrusora.resources.exceptions;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandarError> resourceNotFound(ResourceNotFoundException e,HttpServletRequest request){
		...
		String error = "Recurso nã encontrado";
	...
	public ResponseEntity<StandarError> erroComunicao(ErroComunicacaoMicroserviceException e,HttpServletRequest request){
		
		String error = "Servico indisponivel";
